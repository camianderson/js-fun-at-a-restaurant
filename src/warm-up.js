...
// Initialize three new variables, "food", "type" and "inStock", and assign values to them with a food's name, type and number of items in stock.
...
var vegetables = ["brocolli", "onion", "tomato", "carrot", "garlic"];
...
// different fruits.
var fruits = ["grape", "kiwi", "raspberry", "strawberry", "blueberry", "dragon fruit", "pineapple"];
